        ...
        Dota2.on("ready", function () {
          ...
          Dota2.on("practiceLobbyUpdate", async function (lobby) {
            ...
            if(!areLobbySettingsAdd){
              Dota2.configPracticeLobby(lobby.lobby_id,{
                        game_name: "Match#" + currentMatch.matchNumber,
                        server_region: 3,
                        game_mode: 1,
                        game_version: 1,
            ...
            if(!isInLobbyChat){
              ...
              let players = [...currentMatch.playersT1,...currentMatch.playersT2];
            ...
            //   }
              Dota2.on("chatJoin" ,(channel, joiner_name, joiner_steam_id, otherJoined_object)=>{
             ...
             if(canCheckMatchStart){
              ...
              for (let i = 1 ; i < lobby.all_members.length; i++) {
                console.log(lobby.all_members[i].team === 0, lobby.all_members[i].team === 1);
                if(lobby.all_members[i].team === 0 || lobby.all_members[i].team === 1){
